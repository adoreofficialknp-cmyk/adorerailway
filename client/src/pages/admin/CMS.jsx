  ...
  useEffect(() => {
    try {
      ...
      if (saved) {
        ...
        if (p.marqueeItems) setMarqueeItems(p.marqueeItems)
        ...
        {tab === 'marquee' && (
          <div>
            ...
            <div style={{ display: 'flex', gap: 10, marginBottom: 24 }}>
              ...
              <button className="btn-pink" onClick={() => { if (newMarquee.trim()) { setMarqueeItems(ms => [...ms, newMarquee.trim()]); setNewMarquee('') } }}>+ Add</button>
            </div>
