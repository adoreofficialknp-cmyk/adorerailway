...
function Tile({ item, selected, onClick }) {
  return (
    <div onClick={onClick} style={{ borderRadius:12, overflow:'hidden', cursor:'pointer', border:`2.5px solid ${selected?'#C2185B':'#F8BBD0'}`, background:selected?'#FCE4EC':'#fff', transform:selected?'scale(1.04)':'scale(1)', boxShadow:selected?'0 6px 22px rgba(194,24,91,.28)':'0 2px 8px rgba(194,24,91,.07)', transition:'all .2s', position:'relative' }}>
      {selected && <div style={{ position:'absolute', top:6, right:6, zIndex:3, width:20, height:20, borderRadius:'50%', background:'#C2185B', color:'#fff', display:'flex', alignItems:'center', justifyContent:'center', fontSize:11, fontWeight:800 }}>✓</div>}
      ...
      <section style={{ background:'#fff', padding:'clamp(24px,4vw,40px) 5%', borderTop:'1px solid #FCE4EC' }}>
        <div style={{ maxWidth:820, margin:'0 auto', display:'flex', alignItems:'stretch', gap:20, flexWrap:'wrap' }}>
          ...
          <div style={{ flex:'1 1 180px', border:'1.5px solid #F8BBD0', borderRadius:16, padding:16, background:'#FFF8FB', minWidth:170 }}>
            ...
            <div onClick={()=>navigate('/shop')} style={{ background:'#C2185B', color:'#fff', textAlign:'center', padding:8, borderRadius:8, fontSize:12, fontWeight:700, letterSpacing:'.1em', cursor:'pointer' }}>SEND</div>
          ...
          <div style={{ flex:'1 1 180px', border:'1.5px solid #F8BBD0', borderRadius:16, padding:16, background:'#FFF8FB', minWidth:170, overflow:'hidden' }}>
            <div style={{ background:'#C2185B', color:'#fff', padding:'10px 12px', borderRadius:'10px 10px 0 0', margin:'-16px -16px 12px', fontSize:12, fontWeight:700, display:'flex', alignItems:'center', gap:8 }}>
            ...
            <div style={{ background:'#C2185B', color:'#fff', textAlign:'right', padding:'8px 12px', borderRadius:8, fontSize:12, fontWeight:700, marginTop:12, cursor:'pointer', display:'flex', alignItems:'center', justifyContent:'flex-end', gap:4 }}>SEND <span style={{ fontSize:14 }}>✈</span></div>
          </div>
        </div>
      </section>
