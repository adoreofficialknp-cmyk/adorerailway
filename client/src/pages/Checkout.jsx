...
export default function Checkout() {
  ...
  const handlePlaceOrder = async () => {
    ...
    // Check if online payment method is configured
    if (payMethod === 'razorpay' && (!apiConfig.RAZORPAY_KEY || !apiConfig.RAZORPAY_SECRET)) {
      showToast('Razorpay is not accepting payments right now.', 'error')
      return
    }
    if (payMethod === 'cashfree' && (!apiConfig.CASHFREE_APP_ID || !apiConfig.CASHFREE_SECRET)) {
