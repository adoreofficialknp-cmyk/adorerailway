        ...
        {!isOOS && (
          <button
            ...
            style={{
              ...
              background: '#C2185B', cursor: 'pointer',
              fontSize: 9, fontWeight: 700, letterSpacing: '.05em', textTransform: 'uppercase',
              color: '#fff', fontFamily: "'Jost', sans-serif", borderRadius: 2, transition: 'all .2s',
            }}
            onMouseEnter={e => { e.currentTarget.style.background = '#880E4F'; e.currentTarget.style.borderColor = '#880E4F' }}
            onMouseLeave={e => { e.currentTarget.style.background = '#C2185B'; e.currentTarget.style.borderColor = '#C2185B' }}
          >
            Buy Now
          </button>
        )}
