...
export default function Shop() {
  ...
  }, [cat, sort, search, page, gender, color, material])
        ...
        <div style={{ display: 'flex', gap: 6, flexWrap: 'nowrap', overflowX: 'auto' }}>
          {SORTS.map(s => (
            <button key={s.value} onClick={() => setSort(s.value)} style={{
              ...
              borderColor: sort === s.value ? '#C2185B' : 'var(--ink-10)',
              background: sort === s.value ? '#C2185B' : 'transparent',
      ...
      <div style={{ display: 'flex', gap: 4, marginBottom: 20, overflowX: 'auto', paddingBottom: 4, borderBottom: '1px solid var(--ink-10)', scrollbarWidth: 'none' }}>
        {CATS.map(c => (
          <button key={c} onClick={() => setCat(c)} style={{
            ...
            background: cat === c ? '#C2185B' : 'transparent',
